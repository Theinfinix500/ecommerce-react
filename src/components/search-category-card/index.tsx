...
const SearchCategoryCard = ({ image }: SearchCategoryCardProps) => {
  return (
    <div className="w-[270px] h-[80px] bg-gray-light rounded-lg p-3 flex items-center">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <span className="text-xs text-gray-default font-semibold">240 Item Available</span>
        </div>
      </div>
    </div>
  );
